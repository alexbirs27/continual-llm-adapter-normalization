...
colspacing=0.8em, % Column spacing (also vertical gap between boxes)
...
headerheight=0.115\textheight, % Height of the header
...
\vspace{0.3em}
\begin{center}
\includegraphics[trim=10 5 10 25,clip,width=1.0\textwidth]{task_similarity_A_8h.pdf}\\[2pt]
...
\begin{center}
\includegraphics[trim=20 10 20 15,clip,width=0.495\textwidth]{layer_orthogonality_A_8h.pdf}\hfill
\includegraphics[trim=20 10 20 15,clip,width=0.495\textwidth]{layer_orthogonality_AB_8h.pdf}
\end{center}
